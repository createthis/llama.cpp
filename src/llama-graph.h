...
public:
    ...
    ggml_tensor * get_kq_mask_full_2d() const { return self_kq_mask_full_2d; }
    ...
    // Full-width KV-aware mask for indexer and sparse MLA: F32 [kv_size, PAD(T)] 2D
    ggml_tensor * self_kq_mask_full_2d = nullptr; // F32 [kv_size, PAD(T)]
